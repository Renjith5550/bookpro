...
urlpatterns = [
    ...
    path('operation/cbv/add',views.AddView.as_view(),name="addition"),
    path('operation/cbv/sub',views.SubView.as_view(),name="subtraction"),
    path('operation/cbv/mul',views.MulView.as_view(),name="multiplication"),
    path('operation/cbv/Div',views.DivView.as_view(),name="division"),
